...
type Booking struct {
	...
	CancelFine           *float64            `json:"cancel_fine,omitempty" struct:"cancel_fine,omitempty"`
	CancelAmountFine     *float64            `json:"cancel_amount_fine,omitempty" struct:"cancel_amount_fine,omitempty"`
	...
	IsSuspended          bool                `json:"is_suspended,omitempty" struct:"is_suspended,omitempty"`
	...
	BookingPayment       *BookingPayment     `json:"booking_payment,omitempty" struct:"booking_payment,omitempty" gorm:"foreignKey:booking_id"`
	BookingDetails       *[]BookingDetail    `json:"booking_details,omitempty" struct:"booking_details,omitempty" gorm:"foreignKey:booking_id"`
	BookingBaskets       *[]BookingBasket    `json:"booking_baskets,omitempty" struct:"booking_baskets,omitempty" gorm:"foreignKey:booking_id"`
	BookingCampaigns     *[]BookingCampaign  `json:"booking_campaigns,omitempty" struct:"booking_campaigns,omitempty" gorm:"foreignKey:booking_id"`
	BookingPets          *[]BookingPet       `json:"booking_pets,omitempty" struct:"booking_pets,omitempty" gorm:"foreignKey:booking_id"`
}
