...
type District struct {
	...
	ProvinceID  int             `json:"province_id" struct:"province_id" gorm:"foreignKey:province_id"`
	Province    *Province       `json:"province,omitempty" struct:"province,omitempty" gorm:"foreignKey:province_id"`
